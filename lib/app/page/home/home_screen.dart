...
class _ItemsPromoWidgetState extends State<_ItemsPromoWidget> {
        ...
        GetBuilder<PopularProductController>(
          builder: (popularProduct) => SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) => _itemHotPromo(
                index,
  ...
  Widget _itemHotPromo(int index, ProductModel product) {
    ...
    return Transform(
      ...
      child: GestureDetector(
        ...
        child: Stack(
          children: [
            _ItemPromoImgWidget(
                imgUrl: "${AppConstansts.BASE_URL}/uploads/${product.img!}"),
            _ItemPromoInfoBlok(product: product),
          ],
        ),
      ),
    );
...
class _ItemPromoInfoBlok extends StatelessWidget {
  const _ItemPromoInfoBlok({Key? key, required this.product}) : super(key: key);
